...
<head>
    <meta charset="utf-8"/>
    <title>{{settings('title','new')}}</title>
    <base href="{{url('')}}">
    ...
    <link href="front/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css" rel="stylesheet" type="text/css"/>
    ...
    <style>
        ...
        .message-item:hover .tools-wrapper {
            opacity: 1;
        }
...
<!--begin::Body-->
<body id="kt_body"
      class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed  aside-minimize page-loading">
<!--begin::Main-->
<!--begin::Header Mobile-->
<div id="kt_header_mobile" class="header-mobile">
    <!--begin::Logo-->
    <a href="index.html">
        <img alt="Logo" src="front/media/logos/logo-letter-2.png" class="logo-default max-h-30px"/>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
...
<div class="d-flex flex-column flex-root">
    ...
    @include('layout.front.partials._aside')
    <!--begin::Wrapper-->
                            ...
                            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions"
                                ...
                                <a href="#" class="btn btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<span class="svg-icon svg-icon-lg">
												<!--begin::Svg Icon | path:front/media/svg/icons/Files/File.svg-->
												<svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http://keenthemes.com/metronic" target="_blank"
                           class="text-dark-75 text-hover-primary">جميع الحقوق محفوظة لموقع rasool</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
...
{{--										<img src="front/media/svg/misc/006-plurk.svg" class="h-50 align-self-center"--}}
{{--                                             alt=""/>--}}
{{--									</span>--}}
{{--                        </div>--}}
{{--                        <div class="d-flex flex-column flex-grow-1 mr-2">--}}
...
{{--                        <div class="symbol symbol-50 symbol-light mr-5">--}}
{{--									<span class="symbol-label">--}}
{{--										<img src="front/media/svg/misc/015-telegram.svg" class="h-50 align-self-center"--}}
{{--                                             alt=""/>--}}
{{--									</span>--}}
{{--                        </div>--}}
{{--                        <div class="d-flex flex-column flex-grow-1 mr-2">--}}
...
{{--                        <div class="symbol symbol-50 symbol-light mr-5">--}}
{{--									<span class="symbol-label">--}}
{{--										<img src="front/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center"--}}
{{--                                             alt=""/>--}}
{{--									</span>--}}
{{--                        </div>--}}
{{--                        <div class="d-flex flex-column flex-grow-1 mr-2">--}}
...
{{--                        <div class="symbol symbol-50 symbol-light mr-5">--}}
{{--									<span class="symbol-label">--}}
{{--										<img src="front/media/svg/misc/005-bebo.svg" class="h-50 align-self-center"--}}
{{--                                             alt=""/>--}}
{{--									</span>--}}
{{--                        </div>--}}
{{--                        <div class="d-flex flex-column flex-grow-1 mr-2">--}}
...
<script src="front/js/scripts.bundle.js"></script>
...
<script !src="">
    ...
    window.imageUploadUrl = "{{route('multifileupload')}}";
    $('.select2').select2({
        placeholder: 'احتر',
    });
    $.ajaxSetup({
