                                ...
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-50 mr-3">
                                        <label class="checkbox checkbox-lg checkbox-inline">
                                            <input type="checkbox" name="groups_id[]" value="{{$group->id}}"/>
                                            <span></span>
                                        </label>
                                    </div>
                                    <div class="symbol symbol-circle symbol-50 mr-3">
                ...
                <div class="card-header align-items-center px-4 py-3">
                    ...
                    <div class="text-center text-center">
                        <div class="symbol-group symbol-hover justify-content-center">
                            ...
                            @endforeach
                            @if(($remainCount=($groupSelected->contacts->count() - 5))>0)
                        ...
                        <div class="messages">
                            ...
                            <div class="d-flex flex-column mb-5 align-items-end">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-35 ml-3">
                                        <img alt="Pic" src="front/media/users/300_1.jpg"/>
                                    </div>
                                </div>
                                <div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px">
